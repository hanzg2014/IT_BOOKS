...
public class Ch04_1_1ReadImgAndSave {
   ...
   {
      try{
         Mat source = Imgcodecs.imread("C://opencv3.1//samples//7.png");
         List<Mat> bgrList = new ArrayList<Mat>(3);
        
         System.out.println("channels="+source.channels());//¦Ç¶¥=1,RGB=3
         ...
         System.out.println("m="+source.dump());//(BGR,BGR......9²Õ,¦@9x3=27(col),row=10)
         ...
         Imgcodecs.imwrite("C://opencv3.1//samples//7.jpg", source);
         }catch (Exception e) {
